...
class AllReportsCompletedThisWeek implements FromCollection,  WithHeadings, WithTitle, WithStrictNullComparison, ShouldAutoSize
{
    /**
    ...
    */
    ...
    {
        return 'Reports Resolved This Week';
    }
}
