...
class OutstandingReportsCompletedThisFortnight implements FromCollection, WithHeadings, WithTitle
{ 
    ...
    {
        return 'All Outstanding Reports Completed This Fortnight';
    }
}
