...
class OutstandingReportsCompletedThisWeek implements FromCollection, WithHeadings, ShouldAutoSize,WithTitle
{
    ...
    {
        return 'All Outstanding Reports Completed This Week';
    }
}
