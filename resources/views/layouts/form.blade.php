        ...
        <nav class="navbar  navbar-expand-md  navbar-light shadow-sm ">
            ...
            <div id="menu" class="container">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="item" href="{{ route('report.index') }}">Home</a></li>
                    @if (Auth::user()->isAdmin =="0")
                    <li class="nav-item"><a class="item"   href="{{ route('report.create') }}"> Create Report</a></li>
                        
                    <li class="nav-item"><a class="item"  href="{{ route('reportlist') }}">My Reports </a></li>
                    @endif
                       
                    @if(Auth::user()->isAdmin == "1")
                        <li class="nav-item"><a class="item"   href="{{ route('adminreportlist') }}">My Reports</a></li>
                        <li class="nav-item"><a class="item"  href="{{ route('admin.statistics') }}">Statistics</a> </li>
                    @endif
